...
public class RuleOrigin {
    ...
    public boolean checkO(String x) {
    	...
    	if (count == 1) {
			...
			if ("i".equals(String.valueOf(x.charAt(x.indexOf(temp) - 1)))) {
				return true;
			}
    	...
    	if (count == 1) {
			...
			if (!last.equals("")) {
				if (temp.equals("ù") || temp.equals("ũ")) {
					if (consonantLastU[1].equals(last) || consonantLastU[4].equals(last) ||
							consonantLastU[6].equals(last) || consonantLastU[10].equals(last) ||
							consonantLastU[16].equals(last) || consonantLastU[21].equals(last) ||
							consonantLastU[22].equals(last) || consonantLastU[23].equals(last) ||
							consonantLastU[26].equals(last) || consonantLastU[28].equals(last) ||
							consonantLastU[31].equals(last) || consonantLastU[33].equals(last)) {
						return false;
					}
				}
...
//			last = removeAccent(last);
//			
//			if (mark && "aâu".contains(removeAccent(String.valueOf(x.charAt(x.indexOf(temp) - 1))))) {
//				return true;
//			}
//			
